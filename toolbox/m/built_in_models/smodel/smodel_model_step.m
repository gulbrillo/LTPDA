% A built-in model of class ao called step
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: A built-in model of class ao called step
%
% CALL:
%           mdl = smodel(plist('built-in', 'step'));
%
% INPUTS:
%
%
...
%
% INFO:
%   <a href="matlab:utils.models.displayModelOverview('smodel_model_step')">Model Information</a>
%
%
% REFERENCES:
%
...
function varargout = smodel_model_step(varargin)
...
function desc = getModelDescription
  desc = 'constructs a step-function of amplitude A at time toff.';
end
...
function varargout = version1(varargin)
  ...
  a.setXvar('t');
  a.setParams({'A','toff'}, {[],[]});
  a.setName('Step at toff');
  a.setDescription('Step function of amplitude A at time toff');
