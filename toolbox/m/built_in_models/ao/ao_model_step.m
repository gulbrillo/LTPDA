% AO_MODEL_STEP constructs a step-function time-series
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: AO_MODEL_STEP constructs a step-function time-series
%
% CALL:        a = ao(plist('built-in', 'step'), pl);
%
% OUTPUTS:
...
%
% INFO:
%   <a href="matlab:utils.models.displayModelOverview('ao_model_step')">Model Information</a>
%
%
% REFERENCES:
%
...
function varargout = ao_model_step(varargin)
...
function desc = getModelDescription
  desc = 'Constructs a step-function time-series';
end
  ...
  if nargin == 1 && ischar(varargin{1})
    switch varargin{1}
      case 'plist'
        ...
        % parameter 'Toff'
        p = param({'Toff', ['Offset of the step, as a number of seconds']}, {1, {0}, paramValue.OPTIONAL});
        pl.append(p);
