...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_uoh', 'setPlotColor')">Parameter Sets</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function varargout = setPlotColor(varargin)
  ...
  for kk=1:numel(bs)
    ...
    obj.plotinfo.style.setColor(utils.prog.mcolor2jcolor(val));
