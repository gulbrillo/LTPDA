...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SETPLOTLINEWIDTH sets the linewidth of a the object's plotinfo.
%
% If the object currently has no plotinfo object defined, a default one is
% created with the chosen style.
%
% CALL:            objs.setPlotLinewidth(val);
%            out = objs.setPlotLinewidth(val);
%
% INPUTS:
%                  objs  - Any shape of ltpda_uoh objects
%                    val - A linewidth
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_uoh', 'setPlotLinewidth')">Parameter Sets</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function varargout = setPlotLinewidth(varargin)
  ...
  for kk=1:numel(bs)
    ...
    % set style
    obj.plotinfo.style.setLinewidth(java.lang.Double(val));
...
function pl = buildplist()
  pl = plist({'value', 'The linewidth to set.'}, paramValue.DOUBLE_VALUE(1));
end
