...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SETPLOTMARKERSIZE sets the markersize of a the object's plotinfo.
%
% If the object currently has no plotinfo object defined, a default one is
% created with the chosen style.
%
% CALL:            objs.setPlotMarkersize(val);
%            out = objs.setPlotMarkersize(val);
%
% INPUTS:
%                  objs  - Any shape of ltpda_uoh objects
%                    val - A markersize
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_uoh', 'setPlotMarkersize')">Parameter Sets</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function varargout = setPlotMarkersize(varargin)
  ...
  for kk=1:numel(bs)
    ...
    % set style
    obj.plotinfo.style.setMarkersize(java.lang.Double(val));
...
function pl = buildplist()
  pl = plist({'value', 'The marker size to set.'}, paramValue.DOUBLE_VALUE(10));
end
