...
%
% <a href="matlab:utils.helper.displayMethodInfo('smodel', 'generateConstructorPlist')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function pl = generateConstructorPlist(varargin)
  ...
  % Add expression
  pl.append('expression', obj.expr);
  
  % Add params
  appendProperty(pl, obj, 'params');
  
  % Add values
  appendProperty(pl, obj, 'values');
  
  % Add trans
  appendProperty(pl, obj, 'trans');
  
  % Add xvar
  appendProperty(pl, obj, 'xvar');
  
  % Add xvals
  appendProperty(pl, obj, 'xvals');
  
  % Add xunits
  appendProperty(pl, obj, 'xunits');
