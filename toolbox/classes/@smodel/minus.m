...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: MINUS implements subtraction operator for two smodel objects.
%
% CALL:        obj = obj1-obj2
%              obj = minus(obj1,obj2);
%
% <a href="matlab:utils.helper.displayMethodInfo('smodel', 'minus')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
