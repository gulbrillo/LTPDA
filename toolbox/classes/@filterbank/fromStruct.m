% FROMSTRUCT creates from a structure a FILTERBANK object.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% FUNCTION:    fromStruct
%
% DESCRIPTION: Creates from a structure a FILTERBANK object.
%
...
function objs = fromStruct(objs, obj_struct)
  ...
  for kk = 1:numel(obj_struct)
    ...
    % Set 'filters' object
    if isfield(up_struct, 'filters')
      objs(kk).filters = utils.helper.getObjectFromStruct(up_struct.filters);
    end
    
    % Set 'type' object
    if isfield(up_struct, 'type')
      objs(kk).type = utils.helper.getObjectFromStruct(up_struct.type);
    end
