% TEST_PSD_INPUT tests the cpsd method with an input PSD matrix.
function res = test_psd_input(varargin)
  ...
  psdscale = [1 1]; % The model has two inputs
  ...
  % Return message
  res = 'ssm/psd passed cpsd input tests';
