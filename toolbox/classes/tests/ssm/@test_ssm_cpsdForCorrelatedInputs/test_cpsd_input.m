% TEST_CPSD_INPUT tests the cpsdForCorrelatedInputs method with an input CPSD matrix.
function res = test_cpsd_input(varargin)
  ...
  % Return message
  res = 'ssm/cpsdForCorrelatedInputs passed cpsd input tests';
