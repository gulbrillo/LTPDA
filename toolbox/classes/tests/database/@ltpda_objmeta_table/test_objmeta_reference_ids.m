%
% DESCRIPTION: Tests that the metadata 'reference_ids' of a database
...
function varargout = test_objmeta_reference_ids(varargin)
  ...
  if ~utp.testRunner.skipRepoTests()
    ...
    try
      for nn = 1:numel(utp.objIds)
        ...
        % get 'reference_ids' from the objmeta table
