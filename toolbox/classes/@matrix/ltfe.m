...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: LTFE estimates the transfer function between the elements of the 
%              vector input on a log-spaced frequency axis. The elements
%              are expected to be time-series AOs, otherwise an error will
%              occur.
%
% The input should be a vector of time-series AOs of length N. LTFE will
...
%
% <a href="matlab:utils.helper.displayMethodInfo('matrix', 'ltfe')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
