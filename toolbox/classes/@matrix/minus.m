...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: MINUS implements subtraction operator for two matrix objects.
%
% CALL:        obj = obj1-obj2
%              obj = minus(obj1,obj2);
%              obj = minus(obj1,obj2,obj3) == minus(minus(obj1,obj2),obj3)
%
% REMARK:      More than two inputs are handled with nested calls.
%              (This doesn't work at the moment. Do we need this?)
%
% <a href="matlab:utils.helper.displayMethodInfo('matrix', 'minus')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function varargout = minus(varargin)
  ...
  if nargout == 0
    error('### Subtraction operator can not be used as a modifier.');
  end
