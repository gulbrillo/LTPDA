...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SUM computes the sum of the data in the AO.
%
% CALL:        ao_out = sum(ao_in);
%              ao_out = sum(ao_in, pl);
%
% <a href="matlab:utils.helper.displayMethodInfo('ao', 'sum')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function varargout = sum(varargin)
  ...
  % is the correct type and shape for doing sum.
