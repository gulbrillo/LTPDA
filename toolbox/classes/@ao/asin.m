...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: ASIN overloads the asin operator for analysis objects.
%              Inverse sine result in radians.
%              ASIN(ao) is the arcsine of the elements of ao.data.
%
% CALL:        ao_out = asin(ao_in);
%              ao_out = asin(ao_in, pl);
%              ao_out = asin(ao1, pl1, ao_vector, ao_matrix, pl2);
%
% <a href="matlab:utils.helper.displayMethodInfo('ao', 'asin')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
