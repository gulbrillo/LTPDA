...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SETZUNITS sets the 'zunits' property of the ao.
%
% CALL:        objs.setZunits(val);
%              objs.setZunits(val1, val2);
%              objs.setZunits(plist('ZUNITS', val));
%              objs = objs.setZunits(val);
%
...
%                      cell-array
%
% <a href="matlab:utils.helper.displayMethodInfo('ao', 'setZunits')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Setter function to set the zunits
function value = setterFcn(obj, plHist, value)
  obj.data.setZunits(value);
end
...
function pl = buildplist()
  pl = plist({'ZUNITS', 'The unit to set.'}, paramValue.EMPTY_STRING);
end
