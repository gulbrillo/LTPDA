...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: MEDIAN computes the median value of the data in the AO.
%
% CALL:        ao_out = median(ao_in);
%              ao_out = median(ao_in, pl);
%
% <a href="matlab:utils.helper.displayMethodInfo('ao', 'median')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function varargout = median(varargin)
  ...
  % is the correct type for doing median.
