...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: Get the z axis name of the underlying data object.
%
% CALL:        val = zaxisname(a1,a2,a3,...)
%              val = zaxisname(as)
%              val = as.zaxisname()
%
...
%
% <a href="matlab:utils.helper.displayMethodInfo('ao', 'zaxisname')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function varargout = zaxisname(varargin)
  ...
  out = {};
  for jj = 1:numel(as)
    if isprop_core(as(jj).data, 'zaxis')
      out{jj} = as(jj).data.zaxisname;
    else
