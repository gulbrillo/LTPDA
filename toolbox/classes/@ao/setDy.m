...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SETDY sets the 'dy' property of the ao.
%
% CALL:        objs.setDy(val);
%              objs.setDy(val1, val2);
%              objs.setDy(plist('dy', val));
%              objs = objs.setDy(val);
%
...
%                      this function the y-values of this AO for 'dy'.
...
%                      cell-array
%
% <a href="matlab:utils.helper.displayMethodInfo('ao', 'setDy')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function pl = buildplist()
  pl = plist({'dy', 'The vector to set'}, paramValue.EMPTY_DOUBLE);
end
