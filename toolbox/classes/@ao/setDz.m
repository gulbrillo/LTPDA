...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SETDZ sets the 'dz' property of the ao.
%
% CALL:        objs.setDz(val);
%              objs.setDz(val1, val2);
%              objs.setDz(plist('dz', val));
%              objs = objs.setDz(val);
%
...
%                      cell-array
%
% <a href="matlab:utils.helper.displayMethodInfo('ao', 'setDz')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function pl = buildplist()
  pl = plist({'dz', 'The vector to set'}, paramValue.EMPTY_DOUBLE);
end
