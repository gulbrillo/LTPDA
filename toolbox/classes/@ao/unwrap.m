...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: UNWRAP overloads the unwrap operator for analysis objects.
%
% CALL:        ao_out = unwrap(ao_in);
%              ao_out = unwrap(ao_in, pl);
%
% <a href="matlab:utils.helper.displayMethodInfo('ao', 'unwrap')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
