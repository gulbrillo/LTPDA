% iplotPSD iplotPSD plots the sqrt of PSD AOs a ltpda_container object, including error bars
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: iplotPSD iplotPSD plots the sqrt of PSD AOs a ltpda_container object, including error bars
%
% CALL:        out = iplotPSD(in, pl);
%
% Note: this is just a wrapper of ao/iplotPSD. Each AO in the ltpda_container is passed
% to ao/iplotPSD with the input plist. 
% 
...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_container', 'iplotPSD')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function varargout = iplotPSD(varargin)
  ...
  switch class(ms)
    case 'collection'
      varargout{1} = iplotPSD(ms.getObjectsOfClass('ao'), pl, getInfo('None'), obj_invars, methodName);
    otherwise
