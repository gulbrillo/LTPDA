...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_container', 'dsmean')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function varargout = dsmean(varargin)
  ...
  [ms, onj_invars, rest] = utils.helper.collect_objects(varargin(:), 'ltpda_container', in_names);
  [pl, pl_invars, rest]     = utils.helper.collect_objects(rest(:), 'plist', in_names);
  
  % call the ltpda_container wrapper
  varargout{1} = wrapper(ms, pl, getInfo('None'), onj_invars, methodName);  
