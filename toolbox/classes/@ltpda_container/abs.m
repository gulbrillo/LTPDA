...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: ABS overloads the Absolute value method for analysis objects in a ltpda_container object.
%
% CALL:        out = abs(in);
%
% Note: this is just a wrapper of ao/abs. Each AO in the ltpda_container is passed
% to ao/abs with the input plist.
% 
...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_container', 'abs')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
