% SIMPLIFYYUNITS overloads the simplifyYunits value method for analysis objects in a ltpda_container object.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SIMPLIFYYUNITS overloads the simplifyYunits value method for analysis objects in a ltpda_container object.
%
% CALL:        out = simplifyYunits(in);
%
% Note: this is just a wrapper of ao/simplifyYunits. Each AO in the ltpda_container is passed
% to ao/simplifyYunits with the input plist.
% 
...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_container', 'simplifyYunits')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
