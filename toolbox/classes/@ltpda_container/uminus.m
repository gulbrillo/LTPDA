...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: UMINUS overloads the uminus operator for all AOs in the ltpda_container.
%
% CALL:        out = uminus(in, pl);
% 
...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_container', 'uminus')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
