...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: DETREND detrends the analysis objects in a ltpda_container 
%              object using a polynomial of degree N.
%
% CALL:        out = detrend(in, pl);
%
% Note: this is just a wrapper of ao/detrend. Each AO in the ltpda_container is passed
% to ao/detrend with the input plist. 
% 
...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_container', 'detrend')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
