...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: CONSOLIDATE resamples onto the same time grid
%              all input AOs in a ltpda_container object.
%
% CALL:        out = consolidate(in, pl);
%
% Note: this is just a wrapper of ao/consolidate. Each AO in the ltpda_container is passed
% to ao/consolidate with the input plist. 
% 
...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_container', 'consolidate')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
