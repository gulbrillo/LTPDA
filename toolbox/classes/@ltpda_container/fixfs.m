...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: FIXFS adjusts the sample frequency of each time-series AO in the ltpda_container.
%
% CALL:        out = fixfs(in, pl);
%
% Note: this is just a wrapper of ao/fixfs. Each AO in the ltpda_container is passed
...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_container', 'fixfs')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
