...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: INTERPMISSING interpolate missing samples of each time-series AO in the ltpda_container.
%
% CALL:        out = interpmissing(in, pl);
%
% Note: this is just a wrapper of ao/interpmissing. Each AO in the ltpda_container is passed
% to interpmissing with the input plist. 
% 
...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_container', 'interpmissing')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
