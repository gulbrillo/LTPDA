...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SQRT computes the sqrt of each object in the ltpda_container.
%
% CALL:        out = sqrt(in, pl);
%
% Note: this is just a wrapper of ao/sqrt.
% 
...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_container', 'sqrt')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
