% LINFIT returns the fit parameters for a linear fit of the form  y = m*x + b.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DESCRIPTION:
% LINFIT returns the textbook-formulas based parameters for a linear fit 
% of the form  y = m*x + b.
%
% CALL:
% out = linfit(x, y, dy, varargin)
% out = linfit(x, y, [], varargin)
% out = linfit(x, y)
% out = linfit(x, y, dy, 'dx', dx)
%
...
% q     the estimated value for the intercept of the line
% dm    the estimated value for the uncertainty of the slope of the line
% dq    the estimated value for the uncertainty of the intercept of the line
...
function out = linfit (x, y, dy, varargin)
  ...
  if noerrors
    ...
    out = utils.math.linfit(x, y, dy_post);
    m  = out.m;
    b  = out.b;
    dm = out.dm;
    db = out.db;
    ...
    if ~isempty(dx)
      ...
      out = utils.math.linfit(x, y, dy_est);
      m    = out.m;
      b    = out.b;
      dm   = out.dm;
      db   = out.db;
