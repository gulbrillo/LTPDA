...
% HASH - Convert an input variable into a message digest.
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
...
%        (5) This is a direct copy of the code from Michael Kleder. Only
%            the function name was changed to bring it in line with the 
%            LTPDA naming convention. (M Hewitson 15-09-07)
% 
% EXAMPLE:
%
...
% end
% 
% NOTE:   Original taken from MATHWORKS file exchange.
% Author: Michael Kleder, Nov 2005 
% http://www.mathworks.com/matlabcentral/fileexchange/loadFile.do?objectId=8944&objectType=file
% 
% 
