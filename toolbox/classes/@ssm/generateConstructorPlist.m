...
function pl = generateConstructorPlist(varargin)
  ...
  % Add amats
  appendProperty(pl, obj, 'amats');
  
  % Add bmats
  appendProperty(pl, obj, 'bmats');
  
  % Add cmats
  appendProperty(pl, obj, 'cmats');
  
  % Add dmats
  appendProperty(pl, obj, 'dmats');
  
  % Add timestep
  appendProperty(pl, obj, 'timestep');
  
  % Add params
  appendProperty(pl, obj, 'params');
  
  % Add statenames
  appendProperty(pl, obj, 'statenames');
  
  % Add inputnames
  appendProperty(pl, obj, 'inputnames');
  
  % Add outputnames
  appendProperty(pl, obj, 'outputnames');
