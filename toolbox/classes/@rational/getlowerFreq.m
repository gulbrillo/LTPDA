...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: GETLOWERFREQ gets the frequency of the lowest pole in the
%              model.
%
% CALL:        f = getlowerFreq(pf);
%
% <a href="matlab:utils.helper.displayMethodInfo('rational', 'getlowerFreq')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
