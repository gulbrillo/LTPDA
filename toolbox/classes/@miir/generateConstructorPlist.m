...
function pl = generateConstructorPlist(varargin)
  ...
  % Add a
  appendProperty(pl, obj, 'a');
  
  % Add b
  appendProperty(pl, obj, 'b');
  
  % Add histout
  appendProperty(pl, obj, 'histout');
  
  % Add histin
  appendProperty(pl, obj, 'histin');
  
  % Add infile
  appendProperty(pl, obj, 'infile');
  
  % Add fs
  appendProperty(pl, obj, 'fs');
