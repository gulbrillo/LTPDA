% TOHTMLTABLE convert an ltpda_minfo object to a html table without <HTML>, <BODY>, ... tags
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: TOHTMLTABLE convert an ltpda_minfo object to a html table without
%              <HTML>, <BODY>, ... tags
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function varargout = tohtmlTable(obj, relPathToHelp)
  ...
  % Table of the ltpda_minfo object
  html = [html sprintf('    <p><!-- Table of the ltpda_minfo object -->\n')];
