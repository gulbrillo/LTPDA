...
%
% <a href="matlab:utils.helper.displayMethodInfo('mfh', 'generateConstructorPlist')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function pl = generateConstructorPlist(varargin)
  ...
  % Add func
  appendProperty(pl, obj, 'func');
  
  % Add subfuncs
  appendProperty(pl, obj, 'subfuncs');
  
  % Add inputs
  appendProperty(pl, obj, 'inputs');
  
  % Add inputObjects
  appendProperty(pl, obj, 'inputObjects');
  
  % Add constants
  appendProperty(pl, obj, 'constants');
  
  % Add constObjects
  appendProperty(pl, obj, 'constObjects');
