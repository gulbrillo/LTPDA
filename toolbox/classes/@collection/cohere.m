...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: COHERE estimates the coherence between time-series objects in a collection object.
%
% CALL:        out = cohere(in, pl);
%
% Note: this is just a wrapper of ao/cohere. Each couple of AOs in the collection is passed
% to ao/cohere with the input plist. 
% 
...
%
% <a href="matlab:utils.helper.displayMethodInfo('collection', 'cohere')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function varargout = cohere(varargin)
  ...
  % call the cohere method on the AOs
  % loop over objects
  N = numel(cs.objs);
  for kk = 1:N
    o_kk = cs.objs{kk};
