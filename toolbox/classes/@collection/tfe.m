...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: TFE estimates the transfer function between time-series objects in a collection object.
%
% CALL:        out = tfe(in, pl);
%
% Note: this is just a wrapper of ao/tfe. Each couple of AOs in the collection is passed
% to ao/tfe with the input plist. 
% 
...
%
% <a href="matlab:utils.helper.displayMethodInfo('collection', 'tfe')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function varargout = tfe(varargin)
  ...
  % call the tfe method on the AOs
  % loop over objects
  N = numel(cs.objs);
  for kk = 1:N
    o_kk = cs.objs{kk};
