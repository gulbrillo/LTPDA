...
def main():
  ...
  for j in range(0,len(entries)):
    ...
    if len(htmlfile.split('/')) == 2:
      outdir  = htmlfile.split('/')[0]
      outfile = htmlfile.split('/')[1]
      _mkdir(outdir)
    else:
      outdir = ''
      outfile = htmlfile.split('/')[0]
    ...
    # insert content link
    contentFilePath = htmlfile.split('.html')[0]+'_content.html'
    if len(contentFilePath.split('/'))>1:
      conoutdir = contentFilePath.split('/')[0]
      conout    = contentFilePath.split('/')[1]
    else:
      conoutdir = ''
      conout    = contentFilePath.split('/')[0]
