% FROMSTRUCT creates from a structure a TIME object.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% FUNCTION:    fromStruct
%
% DESCRIPTION: Creates from a structure a TIME object.
%
...
function objs = fromStruct(objs, obj_struct)
  ...
  for kk = 1:numel(obj_struct)
    ...
    % Set 'utc_epoch_milli' object
    if isfield(up_struct, 'utc_epoch_milli')
      objs(kk).utc_epoch_milli = up_struct.utc_epoch_milli;
    end
