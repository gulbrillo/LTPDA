...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SETGAIN sets the 'gain' property of the pzmodel object.
%
% CALL:        objs.setGain(val);
%              objs.setGain(val1, val2);
%              objs.setGain(plist('gain', val));
%              objs = objs.setGain(val);
%
% INPUTS:      objs: Can be a vector, matrix, list, or a mix of them.
%              val:  numeric value in seconds
%                 1. Single vector e.g. 1.12
%                      Each pzmodel object in objs get this value.
%                 2. Single vector in a cell-array e.g. {1.12}
%                      Each pzmodel object in objs get this value.
%                 3. cell-array with the same number of vectors as in objs
%                    e.g. {1.2, 2, 4} and 3 pzmodel object in objs
%                      Each pzmodel object in objs get its corresponding
%                      value from the cell-array
%
% <a href="matlab:utils.helper.displayMethodInfo('pzmodel', 'setGain')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function varargout = setGain(varargin)
...
function pl = buildplist()
  pl = plist({'gain', 'New gain for the pole/zero model.'}, []);
end
