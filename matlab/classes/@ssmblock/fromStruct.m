% FROMSTRUCT creates from a structure a SSMBLOCK object.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% FUNCTION:    fromStruct
%
% DESCRIPTION: Creates from a structure a SSMBLOCK object.
%
...
function objs = fromStruct(objs, obj_struct)
  ...
  for kk = 1:numel(obj_struct)
    ...
    % Set 'ports' object
    if isfield(up_struct, 'ports')
      objs(kk).ports = utils.helper.getObjectFromStruct(up_struct.ports);
    end
