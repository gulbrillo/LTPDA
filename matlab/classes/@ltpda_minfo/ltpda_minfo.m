...
% CONSTRUCTORS:
%     
%       m = ltpda_minfo()               - creates an empty object
%       m = ltpda_minfo(mname,      ... - 
%                 mclass,     ...
%                 mpackage,   ...
%                 mcategory,  ...
...
classdef (Hidden = true) ltpda_minfo < ltpda_nuo
  ...
  methods
    ...
    %                                Constructor                                %
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function ii = ltpda_minfo(varargin)
      ...
      switch nargin
        ...
        case 1
          ...
          if isstruct(varargin{1})
            %%%%%%%%%%   ii = ltpda_minfo(structure)   %%%%%%%%%%
            %%%%%%%%%%   necessary for readxml   %%%%%%%%%%
            ii = fromStruct(ii, varargin{1});
          elseif isa(varargin{1}, 'ltpda_minfo')
        ...
        case 2
          if  isa(varargin{1}, 'org.apache.xerces.dom.ElementImpl') && ...
            ...
            %%%%%%%%%%   obj = ltpda_minfo(DOM node, history-objects)   %%%%%%%%%%
  ...
  methods (Static = true)
    ...
    function ii = getInfo(varargin)
      ii = utils.helper.generic_getInfo(varargin{:}, 'ltpda_minfo');
    end
    ...
    function obj = initObjectWithSize(varargin)
      obj = ltpda_minfo.newarray([varargin{:}]);
    end
