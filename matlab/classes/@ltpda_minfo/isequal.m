% ISEQUAL overloads the isequal operator for ltpda ltpda_minfo objects.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: ISEQUAL overloads the isequal operator for ltpda ltpda_minfo objects.
%
%              Two ltpda_minfo objects are considered equal if the following
