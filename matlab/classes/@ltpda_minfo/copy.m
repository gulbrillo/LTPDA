% COPY makes a (deep) copy of the input ltpda_minfo objects.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: COPY makes a deep copy of the input ltpda_minfo objects.
%
% CALL:        b = copy(a, flag)
%
% INPUTS:      a    - input ltpda_minfo object
...
function varargout = copy(varargin)
  ...
  if deepcopy
    % Loop over input ltpda_minfo objects
    new = ltpda_minfo.newarray(size(old));
