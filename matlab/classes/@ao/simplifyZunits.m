% SIMPLIFYZUNITS simplify the 'zunits' of the ao.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SIMPLIFYZUNITS simplify the 'zunits' of the ao.
%
% CALL:        ao = simplifyZunits(ao)
%              obj = obj.simplifyZunits(pl);
%
% <a href="matlab:utils.helper.displayMethodInfo('ao', 'simplifyZunits')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function varargout = simplifyZunits(varargin)
  ...
  for jj = 1:numel(bs)
    ...
    % simplify the units
    bs(jj).data.zaxis.simplifyUnits(prefixes, exceptions);
