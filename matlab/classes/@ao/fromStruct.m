% FROMSTRUCT creates from a structure an analysis object.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% FUNCTION:    fromStruct
%
% DESCRIPTION: Creates from a structure an analysis object.
%
...
function objs = fromStruct(objs, obj_struct)
  ...
  for kk = 1:numel(obj_struct)
    ...
    % Set 'data' object
    if isfield(up_struct, 'data')
      objs(kk).data = utils.helper.getObjectFromStruct(up_struct.data);
    end
