...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: GETPARAMVALUEFORPARAM Returns the paramValue for the specified parameter key.
%
% CALL:        obj = obj.getParamValueForParam('key');
%              obj = obj.getParamValueForParam(plist('key'));
%              obj = getParamValueForParam(obj, 'key');
%
...
function varargout = getParamValueForParam(varargin)
