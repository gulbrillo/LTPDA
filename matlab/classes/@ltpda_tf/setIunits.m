...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SETIUNITS sets the 'iunits' property a transfer function object.
%
...
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_tf', 'setIunits')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function varargout = setIunits(varargin)
  ...
  for jj = 1:numel(fb)
    if numel(values) == 1
      fb(jj).iunits = values{1};
    else
      fb(jj).iunits = values{jj};
    end
    if ~callerIsMethod
