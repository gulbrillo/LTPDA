...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: SETPLOTMARKEREDGECOLOR sets the color of a the object's marker edge.
%
% If the object currently has no plotinfo object defined, a default one is
% created with the chosen style.
%
% CALL:            objs.setPlotMarkerEdgeColor(color);
%            out = objs.setPlotMarkerEdgeColor(color);
%
% INPUTS:
%                  objs  - Any shape of ltpda_uoh objects
%                  color - A MATLAB color string or RGB array.
%
% <a href="matlab:utils.helper.displayMethodInfo('ltpda_uoh', 'setPlotMarkerEdgeColor')">Parameter Sets</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function varargout = setPlotMarkerEdgeColor(varargin)
  ...
  for kk=1:numel(bs)
    ...
    obj.plotinfo.style.setMarkerEdgeColor(utils.prog.mcolor2jcolor(val));
