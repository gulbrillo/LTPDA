% GETNSECS Get the timespan property 'nsecs'.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: GETNSECS Get the timespan property 'nsecs'.
%
% CALL:        val = getNsecs(t1, t2, t3,...)
%              val = getNsecs(ts)
%              val = ts.getNsecs()
%
...
%
% OUTPUTS:     val  - array of double 'nsecs', one for each input
%
% <a href="matlab:utils.helper.displayMethodInfo('timespan', 'nsecs')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function varargout = getNsecs(varargin)
