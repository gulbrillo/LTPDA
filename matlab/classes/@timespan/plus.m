% PLUS Implements addition operator for timespan objects.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: Implements addition operator for timespan objects. Numeric and
...
%
% <a href="matlab:utils.helper.displayMethodInfo('timespan', 'plus')">Parameters Description</a>
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function pl = buildplist()
  pl = plist({'add', 'The time to add to the start and end time of the timespan.'}, paramValue.DOUBLE_VALUE(0));
end
